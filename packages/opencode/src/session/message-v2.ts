...
export const ToolReferenceContent = Schema.Struct({
  type: Schema.Literal("tool_reference"),
  toolName: Schema.String,
})
  .annotate({ identifier: "ToolReferenceContent" })
  .pipe(withStatics((s) => ({ zod: zod(s) })))
export type ToolReferenceContent = Types.DeepMutable<Schema.Schema.Type<typeof ToolReferenceContent>>
...
export const ToolStateCompleted = Schema.Struct({
  ...
  content: Schema.optional(Schema.Array(ToolReferenceContent)),
  time: Schema.Struct({
    start: Schema.Number,
    end: Schema.Number,
